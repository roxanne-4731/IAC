...
class NewsDetails extends Component {
    ...
    handleContent = () => {
        return functions.isObjEmpty(this.props.newsDetails);
    };
    ...
    render() {
        const {title, body, image_id, id} = this.props.newsDetails;
        return (
...
const mapStateToProps = ({iac}) => {
    const {newsDetails} = iac;
    return {newsDetails}
};

export default connect(mapStateToProps, mapActionToProps)(NewsDetails);
